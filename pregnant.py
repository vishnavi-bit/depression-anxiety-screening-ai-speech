...
def give_suggestions(text):
    prompt = ChatPromptTemplate.from_messages([
        (
            ...
            "based strictly on the emotional content of the given text.Give suggestions for pregnant user"
        ),
        (
            "user",
            "Give suggestions for pregnant user"
            "Give All recommendations think the user is pregnant user"
            "Dont give any markdown or ** any Intro or Conclusion message"
...
def pregnant_page():
    ...
    with st.sidebar:
        ...
        st.image("https://media1.giphy.com/media/v1.Y2lkPTZjMDliOTUyemF4OWZ1aHZqb3M1NzUzMm1od3E0YjVuZ3F2OGtva3puajFxdWJpNCZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/SfFGQu7V6cSaOy5iVh/giphy.gif")
    ...
    if selected_tab=='Logout':
        ...
        st.markdown(
            ...
            /* Apply background image to the main content area */
            .main {
                background-image: url('https://img.freepik.com/premium-vector/illustration-pregnant-woman-with-floral-background-pink-purple-tones_1250993-4233.jpg');
                background-size: cover;
                background-position: center;
                background-repeat: no-repeat;
                min-height: 100vh;  /* Ensure the background covers the whole screen */
        ...
        profile_images = [
            "https://static.vecteezy.com/system/resources/previews/047/378/112/non_2x/pregnant-woman-logo-design-pregnancy-logo-design-woman-pregnant-idea-logo-design-inspiration-pregnancy-healthcare-minimal-logo-design-template-maternity-logo-free-vector.jpg",
            "https://media.istockphoto.com/id/1223671379/vector/happy-pregnant-woman-holds-her-belly-decorated-beautiful-leaves.jpg?s=612x612&w=0&k=20&c=v9RXQcBSmZ83K5ldvlMgpVnP0c1y5sPkj_9OxFAZNBU="
        ]
        ...
        .profile-card {
            ...
            padding: 35px;
            border-radius: 20px;
            background: linear-gradient(275deg, pink, #FFFDF1);
